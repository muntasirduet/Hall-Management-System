					...
					<table id="mytable" class="table table-bordred table-striped">
						...
						<?php foreach($req as $data) { ?>
							...
							<tr>
								...
								<td><button class="btn btn-outline-success"><?php echo $data['status'] ?></button></td>

								
								
								<td><a name=""  href='../provost/showAllowDetails.php?id=<?php echo $data['student_id']; ?>'><button type="submit" name="" class="btn btn-primary">view</button></a></td>
							</tr>
							<?php } ?>
						<?php } ?>
...
function showData() {
  ...
  if (str == "") {
    ...
    xmlhttp.open("GET","getAllowStudent.php?id="+str,true);
    xmlhttp.send();
  }
}
</script>
